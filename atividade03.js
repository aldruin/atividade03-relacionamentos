...
console.table(listaDeContas)

const statusConta = (conta, acao) => {
  console.log(`Conta após o ${acao}`)
  console.table(conta)
}
...
statusConta(novaConta, 'saque')

//depositando 2000 na conta
novaConta.depositar(2000);
statusConta(novaConta, 'depósito')

novaCont.retirar(100)
statusConta(novaCont, 'saque')

novaCont.depositar(150)
statusConta(novaCont, 'depósito')